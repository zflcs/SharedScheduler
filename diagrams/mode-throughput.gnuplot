...
set output 'mode-throughput.pdf'
fn(v) = sprintf("%.0f", v)
compare(a, b) = a / b
fn2(v) = sprintf("%.2f", v)
...
plot datafile using 2 with histogram title 'kcuc', '' \
    using 3 with histogram title 'kcut', '' \
    using 4 with histogram title 'ktut', '' \
    using 5 with histogram title 'ktuc', \
