...
set output 'prio-throughput.pdf'
fn(v) = sprintf("%.0f", v)
compare(a, b) = a / b
fn2(v) = sprintf("%.2f", v)
...
plot datafile using 2 with linespoints title 'core-1', '' \
    using 3 with linespoints title 'core-2', '' \
    using 4 with linespoints title 'core-3'
