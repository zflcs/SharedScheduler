...
%DIF ADD sharedscheduler.tex                 Fri Aug  2 20:05:11 2024
...
\begin{table}[htbp]
	\centering
	\caption{\DIFaddFL{Memory usage of the four models.}}
	\label{tab:mem_usage}
	\begin{tabular}{@{}cccc@{}}
		\toprule
		\DIFaddFL{Model }& \makecell{Total Memory \\ Usage(Bytes)} & \DIFaddFL{Kernel                  }& \DIFaddFL{Userland                      }\\ \midrule
		\DIFaddFL{KCUC  }& \DIFaddFL{59904   }& \makecell{0x4000+\\176*64}       & \makecell{0x4000+\\(120+80+64)*64} \\
		\DIFaddFL{KCUT  }& \DIFaddFL{6302720 }& \makecell{0x4000*3*64+\\176*64} & \DIFaddFL{0x4000*3*64               }\\
		\DIFaddFL{KTUT  }& \DIFaddFL{6291456 }& \DIFaddFL{0x4000*3*64         }& \DIFaddFL{0x4000*3*64               }\\
		\DIFaddFL{KTUC  }& \DIFaddFL{65024   }& \DIFaddFL{0x4000+0x4000         }& \makecell{0x4000+\\(120+80+64)*64} \\ \bottomrule
	\end{tabular}
	\vspace{-1.0em}
\end{table}
\DIFaddend 
